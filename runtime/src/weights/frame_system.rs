...
impl<T: frame_system::Config> frame_system::weights::WeightInfo for WeightInfo<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		(13_773_000 as Weight)
			...
			.saturating_add((1_656_000 as Weight).saturating_mul(i as Weight))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(24_667_000 as Weight)
			...
			.saturating_add((1_107_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(i as Weight)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((1_499_000 as Weight).saturating_mul(p as Weight))
