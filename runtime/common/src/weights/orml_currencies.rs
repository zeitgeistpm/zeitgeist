...
impl<T: frame_system::Config> orml_currencies::WeightInfo for WeightInfo<T> {
    ...
    fn transfer_native_currency() -> Weight {
        Weight::from_ref_time(36_676_000 as u64)
    ...
    fn update_balance_non_native_currency() -> Weight {
        Weight::from_ref_time(30_286_000 as u64)
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().writes(3 as u64))
    }
    // Storage: System Account (r:1 w:1)
    fn update_balance_native_currency_creating() -> Weight {
        Weight::from_ref_time(30_106_000 as u64)
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
    // Storage: System Account (r:1 w:1)
    fn update_balance_native_currency_killing() -> Weight {
        Weight::from_ref_time(27_642_000 as u64)
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
}
