...
impl<T: frame_system::Config> orml_currencies::WeightInfo for WeightInfo<T> {
    ...
    fn transfer_non_native_currency() -> Weight {
        ...
        Weight::from_parts(84_561_000, 7803)
    ...
    fn transfer_native_currency() -> Weight {
        ...
        //  Measured:  `1461`
        //  Estimated: `2607`
        // Minimum execution time: 67_971 nanoseconds.
        Weight::from_parts(69_580_000, 2607)
    ...
    fn update_balance_non_native_currency() -> Weight {
        ...
        Weight::from_parts(58_510_000, 7723)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    /// Storage: System Account (r:1 w:1)
    ...
    fn update_balance_native_currency_creating() -> Weight {
        ...
        Weight::from_parts(66_200_000, 2607)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: System Account (r:1 w:1)
    ...
    fn update_balance_native_currency_killing() -> Weight {
        ...
        //  Measured:  `1525`
        //  Estimated: `2607`
        // Minimum execution time: 54_111 nanoseconds.
        Weight::from_parts(55_320_000, 2607)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
