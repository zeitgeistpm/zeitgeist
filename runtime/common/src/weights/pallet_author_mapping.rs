...
impl<T: frame_system::Config> pallet_author_mapping::weights::WeightInfo for WeightInfo<T> {
    ...
    fn add_association() -> Weight {
        ...
        //  Measured:  `430`
        //  Estimated: `3895`
        // Minimum execution time: 60_590 nanoseconds.
        Weight::from_parts(61_920_000, 3895)
    ...
    fn update_association() -> Weight {
        ...
        Weight::from_parts(40_880_000, 6315)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    /// Storage: `AuthorMapping::MappingWithDeposit` (r:1 w:1)
    ...
    fn clear_association() -> Weight {
        ...
        //  Measured:  `519`
        //  Estimated: `3984`
        // Minimum execution time: 62_841 nanoseconds.
        Weight::from_parts(63_960_000, 3984)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    ...
    fn remove_keys() -> Weight {
        ...
        //  Measured:  `625`
        //  Estimated: `4090`
        // Minimum execution time: 74_860 nanoseconds.
        Weight::from_parts(86_720_000, 4090)
    ...
    fn set_keys() -> Weight {
        ...
        Weight::from_parts(67_220_000, 3963)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
}
