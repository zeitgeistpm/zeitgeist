...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(6_710_000, 503)
    ...
    fn service_agenda_base(s: u32) -> Weight {
        ...
        Weight::from_parts(13_039_898, 13142)
            // Standard Error: 8_846
            .saturating_add(Weight::from_parts(518_519, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn service_task_fetched(s: u32) -> Weight {
        ...
        Weight::from_parts(31_240_000, 5252)
            // Standard Error: 6
    ...
    fn service_task_named() -> Weight {
        ...
        Weight::from_parts(10_480_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn schedule(s: u32) -> Weight {
        ...
        Weight::from_parts(29_611_427, 13142)
            // Standard Error: 13_345
            .saturating_add(Weight::from_parts(499_616, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: Scheduler Agenda (r:1 w:1)
    ...
    fn cancel(s: u32) -> Weight {
        ...
        //  Measured:  `114 + s * (181 ±0)`
        //  Estimated: `13142`
        // Minimum execution time: 24_350 nanoseconds.
        Weight::from_parts(30_773_500, 13142)
            // Standard Error: 32_975
            .saturating_add(Weight::from_parts(782_930, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn schedule_named(s: u32) -> Weight {
        ...
        Weight::from_parts(37_350_318, 15669)
            // Standard Error: 15_749
            .saturating_add(Weight::from_parts(515_008, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: Scheduler Lookup (r:1 w:1)
    ...
    fn cancel_named(s: u32) -> Weight {
        ...
        Weight::from_parts(34_370_715, 15669)
            // Standard Error: 18_561
            .saturating_add(Weight::from_parts(820_922, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
