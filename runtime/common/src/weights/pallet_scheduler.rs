...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(6_860_000, 503)
    ...
    fn service_agenda_base(s: u32) -> Weight {
        ...
        Weight::from_parts(14_259_953, 13142)
            // Standard Error: 9_618
            .saturating_add(Weight::from_parts(592_955, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn service_task_fetched(s: u32) -> Weight {
        ...
        Weight::from_parts(38_920_000, 5252)
            // Standard Error: 5
    ...
    fn service_task_named() -> Weight {
        ...
        Weight::from_parts(13_330_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn schedule(s: u32) -> Weight {
        ...
        Weight::from_parts(29_703_459, 13142)
            // Standard Error: 12_535
            .saturating_add(Weight::from_parts(554_122, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: Scheduler Agenda (r:1 w:1)
    ...
    fn cancel(s: u32) -> Weight {
        ...
        Weight::from_parts(30_580_865, 13142)
            // Standard Error: 12_215
            .saturating_add(Weight::from_parts(815_578, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn schedule_named(s: u32) -> Weight {
        ...
        Weight::from_parts(36_285_780, 15669)
            // Standard Error: 15_060
            .saturating_add(Weight::from_parts(651_524, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: Scheduler Lookup (r:1 w:1)
    ...
    fn cancel_named(s: u32) -> Weight {
        ...
        Weight::from_parts(36_381_187, 15669)
            // Standard Error: 16_286
            .saturating_add(Weight::from_parts(803_864, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
