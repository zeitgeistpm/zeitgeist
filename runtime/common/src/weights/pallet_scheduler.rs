...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(3_270_000, 1493)
    ...
    fn service_agenda_base(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(185_161_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn service_task_fetched(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(74_410_741_000, 4197809)
    ...
    fn schedule(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(200_860_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: `Scheduler::Agenda` (r:1 w:1)
    ...
    fn cancel(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(286_911_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
    ...
    fn schedule_named(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(193_951_000, 112539)
    ...
    fn cancel_named(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(289_101_000, 112539)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    /// Storage: `Scheduler::Agenda` (r:1 w:1)
    ...
    fn schedule_retry(_s: u32, ) -> Weight {
        ...
        Weight::from_parts(11_730_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn set_retry() -> Weight {
        ...
        //  Measured:  `92757`
        //  Estimated: `112539`
        // Minimum execution time: 127_970 nanoseconds.
        Weight::from_parts(127_970_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn set_retry_named() -> Weight {
        ...
        //  Measured:  `93803`
        //  Estimated: `112539`
        // Minimum execution time: 131_180 nanoseconds.
        Weight::from_parts(131_180_000, 112539)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: `Scheduler::Agenda` (r:1 w:0)
    ...
    fn cancel_retry() -> Weight {
        ...
        //  Measured:  `92769`
        //  Estimated: `112539`
        // Minimum execution time: 117_990 nanoseconds.
        Weight::from_parts(117_990_000, 112539)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: `Scheduler::Lookup` (r:1 w:0)
    ...
    fn cancel_retry_named() -> Weight {
        ...
        //  Measured:  `93815`
        //  Estimated: `112539`
        // Minimum execution time: 126_071 nanoseconds.
        Weight::from_parts(126_071_000, 112539)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
