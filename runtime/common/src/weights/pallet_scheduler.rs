...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(6_660_000, 503)
    ...
    fn service_agenda_base(s: u32) -> Weight {
        ...
        Weight::from_parts(13_195_112, 13142)
            // Standard Error: 12_609
            .saturating_add(Weight::from_parts(584_778, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn service_task_fetched(s: u32) -> Weight {
        ...
        // Minimum execution time: 31_230 nanoseconds.
        Weight::from_parts(31_790_000, 5252)
            // Standard Error: 7
            .saturating_add(Weight::from_parts(2_427, 0).saturating_mul(s.into()))
    ...
    fn service_task_named() -> Weight {
        ...
        Weight::from_parts(11_990_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn schedule(s: u32) -> Weight {
        ...
        Weight::from_parts(32_473_125, 13142)
            // Standard Error: 15_953
            .saturating_add(Weight::from_parts(471_984, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: Scheduler Agenda (r:1 w:1)
    ...
    fn cancel(s: u32) -> Weight {
        ...
        //  Measured:  `114 + s * (181 ±0)`
        //  Estimated: `13142`
        // Minimum execution time: 27_441 nanoseconds.
        Weight::from_parts(30_393_509, 13142)
            // Standard Error: 15_436
            .saturating_add(Weight::from_parts(835_686, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn schedule_named(s: u32) -> Weight {
        ...
        Weight::from_parts(39_886_526, 15669)
            // Standard Error: 24_317
            .saturating_add(Weight::from_parts(501_616, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: Scheduler Lookup (r:1 w:1)
    ...
    fn cancel_named(s: u32) -> Weight {
        ...
        Weight::from_parts(36_611_230, 15669)
            // Standard Error: 16_371
            .saturating_add(Weight::from_parts(775_681, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
