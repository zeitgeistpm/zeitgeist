...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(6_340_000, 503)
    ...
    fn service_agenda_base(s: u32) -> Weight {
        ...
        //  Estimated: `13142`
        // Minimum execution time: 5_421 nanoseconds.
        Weight::from_parts(15_044_319, 13142)
            // Standard Error: 12_339
            .saturating_add(Weight::from_ref_time(540_060).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    ...
    fn service_task_fetched(s: u32) -> Weight {
        ...
        Weight::from_parts(31_610_000, 5252)
            // Standard Error: 6
            .saturating_add(Weight::from_ref_time(2_338).saturating_mul(s.into()))
    ...
    fn service_task_named() -> Weight {
        ...
        Weight::from_ref_time(12_680_000).saturating_add(T::DbWeight::get().writes(1_u64))
    }
    fn service_task_periodic() -> Weight {
        ...
        Weight::from_ref_time(10_260_000)
    }
    ...
    fn schedule(s: u32) -> Weight {
        ...
        //  Measured:  `114 + s * (181 ±0)`
        //  Estimated: `13142`
        // Minimum execution time: 18_890 nanoseconds.
        Weight::from_parts(31_761_368, 13142)
            // Standard Error: 12_745
            .saturating_add(Weight::from_ref_time(582_142).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: Scheduler Agenda (r:1 w:1)
    ...
    fn cancel(s: u32) -> Weight {
        ...
        Weight::from_parts(30_383_746, 13142)
            // Standard Error: 24_905
            .saturating_add(Weight::from_ref_time(904_743).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    ...
    fn schedule_named(s: u32) -> Weight {
        ...
        Weight::from_parts(38_669_389, 15669)
            // Standard Error: 14_406
            .saturating_add(Weight::from_ref_time(629_425).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    /// Storage: Scheduler Lookup (r:1 w:1)
    ...
    fn cancel_named(s: u32) -> Weight {
        ...
        Weight::from_parts(37_063_103, 15669)
            // Standard Error: 27_105
            .saturating_add(Weight::from_ref_time(848_431).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
}
