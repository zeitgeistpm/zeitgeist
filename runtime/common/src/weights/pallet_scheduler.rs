...
impl<T: frame_system::Config> pallet_scheduler::weights::WeightInfo for WeightInfo<T> {
    ...
    fn service_agendas_base() -> Weight {
        ...
        Weight::from_parts(6_910_000, 503)
    ...
    fn service_agenda_base(s: u32) -> Weight {
        ...
        Weight::from_parts(15_743_204, 13142)
            // Standard Error: 9_341
            .saturating_add(Weight::from_parts(563_979, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn service_task_fetched(s: u32) -> Weight {
        ...
        Weight::from_parts(32_290_000, 5252)
            // Standard Error: 4
    ...
    fn service_task_named() -> Weight {
        ...
        Weight::from_parts(11_580_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn schedule(s: u32) -> Weight {
        ...
        Weight::from_parts(33_098_986, 13142)
            // Standard Error: 12_003
            .saturating_add(Weight::from_parts(605_404, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: Scheduler Agenda (r:1 w:1)
    ...
    fn cancel(s: u32) -> Weight {
        ...
        Weight::from_parts(26_437_367, 13142)
            // Standard Error: 14_878
            .saturating_add(Weight::from_parts(1_022_676, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn schedule_named(s: u32) -> Weight {
        ...
        Weight::from_parts(40_010_187, 15669)
            // Standard Error: 15_936
            .saturating_add(Weight::from_parts(699_125, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: Scheduler Lookup (r:1 w:1)
    ...
    fn cancel_named(s: u32) -> Weight {
        ...
        Weight::from_parts(36_715_188, 15669)
            // Standard Error: 17_393
            .saturating_add(Weight::from_parts(1_024_734, 0).saturating_mul(s.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
