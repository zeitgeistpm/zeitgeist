...
impl<T: frame_system::Config> pallet_utility::weights::WeightInfo for WeightInfo<T> {
    ...
    fn batch(c: u32) -> Weight {
        ...
        Weight::from_parts(3_000_000, 0)
            ...
            .saturating_add(Weight::from_parts(2_071_541, 0).saturating_mul(c.into()))
    }
    ...
    fn batch_all(c: u32) -> Weight {
        ...
        Weight::from_parts(2_940_000, 0)
            ...
            .saturating_add(Weight::from_parts(2_243_460, 0).saturating_mul(c.into()))
    }
    ...
    fn force_batch(c: u32) -> Weight {
        ...
        Weight::from_parts(2_820_000, 0)
            ...
            .saturating_add(Weight::from_parts(2_075_565, 0).saturating_mul(c.into()))
    }
}
