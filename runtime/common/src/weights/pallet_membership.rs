...
impl<T: frame_system::Config> pallet_membership::weights::WeightInfo for WeightInfo<T> {
    ...
    fn add_member(m: u32) -> Weight {
        ...
        Weight::from_parts(32_938_860, 4900)
            // Standard Error: 4_858
            .saturating_add(Weight::from_parts(45_291, 0).saturating_mul(m.into()))
    ...
    fn remove_member(m: u32) -> Weight {
        ...
        Weight::from_parts(36_842_820, 5739)
            // Standard Error: 5_058
            .saturating_add(Weight::from_parts(55_723, 0).saturating_mul(m.into()))
    ...
    fn swap_member(m: u32) -> Weight {
        ...
        Weight::from_parts(36_090_560, 5739)
            // Standard Error: 5_332
            .saturating_add(Weight::from_parts(103_901, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
            .saturating_add(Weight::from_parts(0, 192).saturating_mul(m.into()))
    }
    ...
    fn reset_member(m: u32) -> Weight {
        ...
        Weight::from_parts(36_574_943, 5739)
            // Standard Error: 6_709
            .saturating_add(Weight::from_parts(260_598, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
            .saturating_add(Weight::from_parts(0, 192).saturating_mul(m.into()))
    }
    ...
    fn change_key(m: u32) -> Weight {
        ...
        Weight::from_parts(37_543_843, 5739)
            // Standard Error: 5_311
            .saturating_add(Weight::from_parts(85_516, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn set_prime(m: u32) -> Weight {
        ...
        Weight::from_parts(16_659_247, 3833)
            // Standard Error: 2_155
            .saturating_add(Weight::from_parts(19_111, 0).saturating_mul(m.into()))
    ...
    fn clear_prime(m: u32) -> Weight {
        ...
        Weight::from_parts(6_009_755, 0)
            // Standard Error: 821
            .saturating_add(Weight::from_parts(658, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
