...
impl<T: frame_system::Config> pallet_membership::weights::WeightInfo for WeightInfo<T> {
    ...
    fn add_member(m: u32) -> Weight {
        ...
        // Minimum execution time: 27_350 nanoseconds.
        Weight::from_parts(30_991_548, 4900)
            // Standard Error: 4_777
            .saturating_add(Weight::from_parts(67_925, 0).saturating_mul(m.into()))
    ...
    fn remove_member(m: u32) -> Weight {
        ...
        Weight::from_parts(40_730_106, 5739)
            // Standard Error: 10_014
            .saturating_add(Weight::from_parts(6_852, 0).saturating_mul(m.into()))
    ...
    fn swap_member(m: u32) -> Weight {
        ...
        Weight::from_parts(35_957_095, 5739)
            // Standard Error: 5_726
            .saturating_add(Weight::from_parts(102_602, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
            .saturating_add(Weight::from_parts(0, 192).saturating_mul(m.into()))
    }
    ...
    fn reset_member(m: u32) -> Weight {
        ...
        Weight::from_parts(37_298_323, 5739)
            // Standard Error: 6_902
            .saturating_add(Weight::from_parts(247_508, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
            .saturating_add(Weight::from_parts(0, 192).saturating_mul(m.into()))
    }
    ...
    fn change_key(m: u32) -> Weight {
        ...
        Weight::from_parts(39_553_425, 5739)
            // Standard Error: 5_627
            .saturating_add(Weight::from_parts(51_990, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn set_prime(m: u32) -> Weight {
        ...
        Weight::from_parts(16_653_218, 3833)
            // Standard Error: 4_995
            .saturating_add(Weight::from_parts(41_193, 0).saturating_mul(m.into()))
    ...
    fn clear_prime(m: u32) -> Weight {
        ...
        Weight::from_parts(6_328_054, 0)
            // Standard Error: 816
            .saturating_add(Weight::from_parts(2_277, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().writes(2))
    }
}
