...
impl<T: frame_system::Config> pallet_parachain_staking::weights::WeightInfo for WeightInfo<T> {
    ...
    fn set_staking_expectations() -> Weight {
        ...
        Weight::from_parts(19_820_000, 614)
    ...
    fn set_inflation() -> Weight {
        ...
        //  Measured:  `119`
        //  Estimated: `614`
        // Minimum execution time: 83_421 nanoseconds.
        Weight::from_parts(95_940_000, 614)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn set_parachain_bond_account() -> Weight {
        ...
        Weight::from_parts(19_280_000, 547)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: ParachainStaking ParachainBondInfo (r:1 w:1)
    ...
    fn set_parachain_bond_reserve_percent() -> Weight {
        ...
        Weight::from_parts(19_240_000, 547)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn set_total_selected() -> Weight {
        ...
        Weight::from_parts(20_240_000, 523)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn set_collator_commission() -> Weight {
        ...
        Weight::from_parts(19_030_000, 522)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn set_blocks_per_round() -> Weight {
        ...
        Weight::from_parts(68_000_000, 1284)
    ...
    fn join_candidates(x: u32) -> Weight {
        ...
        Weight::from_parts(87_411_011, 22371)
            // Standard Error: 2_278
            .saturating_add(Weight::from_parts(208_670, 0).saturating_mul(x.into()))
    ...
    fn schedule_leave_candidates(x: u32) -> Weight {
        ...
        Weight::from_parts(40_438_357, 4794)
            // Standard Error: 2_205
            .saturating_add(Weight::from_parts(178_269, 0).saturating_mul(x.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn execute_leave_candidates(x: u32) -> Weight {
        ...
        // Minimum execution time: 101_280 nanoseconds.
        Weight::from_parts(122_190_000, 18229)
            // Standard Error: 216_165
            .saturating_add(Weight::from_parts(47_163_489, 0).saturating_mul(x.into()))
    ...
    fn cancel_leave_candidates(x: u32) -> Weight {
        ...
        // Minimum execution time: 30_160 nanoseconds.
        Weight::from_parts(34_225_633, 4704)
            // Standard Error: 2_459
            .saturating_add(Weight::from_parts(196_665, 0).saturating_mul(x.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(Weight::from_parts(0, 98).saturating_mul(x.into()))
    }
    ...
    fn go_offline() -> Weight {
        ...
        Weight::from_parts(59_570_000, 3712)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking CandidateInfo (r:1 w:1)
    ...
    fn go_online() -> Weight {
        ...
        Weight::from_parts(57_670_000, 3614)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking CandidateInfo (r:1 w:1)
    ...
    fn candidate_bond_more() -> Weight {
        ...
        Weight::from_parts(105_331_000, 11796)
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    /// Storage: ParachainStaking CandidateInfo (r:1 w:1)
    ...
    fn schedule_candidate_bond_less() -> Weight {
        ...
        Weight::from_parts(29_190_000, 2691)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: ParachainStaking CandidateInfo (r:1 w:1)
    ...
    fn execute_candidate_bond_less() -> Weight {
        ...
        Weight::from_parts(75_400_000, 11856)
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    /// Storage: ParachainStaking CandidateInfo (r:1 w:1)
    ...
    fn cancel_candidate_bond_less() -> Weight {
        ...
        //  Measured:  `236`
        //  Estimated: `2711`
        // Minimum execution time: 23_360 nanoseconds.
        Weight::from_parts(26_850_000, 2711)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    /// Storage: System Account (r:1 w:1)
    ...
    fn delegate(x: u32, y: u32) -> Weight {
        ...
        // Minimum execution time: 113_761 nanoseconds.
        Weight::from_parts(117_983_111, 25391)
            // Standard Error: 14_091
            .saturating_add(Weight::from_parts(327_450, 0).saturating_mul(x.into()))
            // Standard Error: 4_622
            .saturating_add(Weight::from_parts(179_482, 0).saturating_mul(y.into()))
    ...
    fn schedule_leave_delegators() -> Weight {
        ...
        Weight::from_parts(34_650_000, 5302)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking DelegatorState (r:1 w:1)
    ...
    fn execute_leave_delegators(x: u32) -> Weight {
        ...
        // Minimum execution time: 100_680 nanoseconds.
        Weight::from_parts(122_370_000, 26542)
            // Standard Error: 170_841
            .saturating_add(Weight::from_parts(39_189_991, 0).saturating_mul(x.into()))
            .saturating_add(T::DbWeight::get().reads(1))
    ...
    fn cancel_leave_delegators() -> Weight {
        ...
        Weight::from_parts(37_080_000, 5546)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking DelegatorState (r:1 w:1)
    ...
    fn schedule_revoke_delegation() -> Weight {
        ...
        Weight::from_parts(33_460_000, 5302)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn delegator_bond_more() -> Weight {
        ...
        //  Measured:  `1066`
        //  Estimated: `23667`
        // Minimum execution time: 75_210 nanoseconds.
        Weight::from_parts(105_021_000, 23667)
    ...
    fn schedule_delegator_bond_less() -> Weight {
        ...
        Weight::from_parts(34_180_000, 5302)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking DelegatorState (r:1 w:1)
    ...
    fn execute_revoke_delegation() -> Weight {
        ...
        Weight::from_parts(113_260_000, 28447)
    ...
    fn execute_delegator_bond_less() -> Weight {
        ...
        //  Measured:  `1188`
        //  Estimated: `24399`
        // Minimum execution time: 78_020 nanoseconds.
        Weight::from_parts(105_651_000, 24399)
            .saturating_add(T::DbWeight::get().reads(8))
            .saturating_add(T::DbWeight::get().writes(8))
    }
    /// Storage: ParachainStaking DelegatorState (r:1 w:1)
    ...
    fn cancel_revoke_delegation() -> Weight {
        ...
        Weight::from_parts(34_500_000, 5546)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: ParachainStaking DelegatorState (r:1 w:1)
    ...
    fn cancel_delegator_bond_less() -> Weight {
        ...
        //  Measured:  `298`
        //  Estimated: `5546`
        // Minimum execution time: 31_110 nanoseconds.
        Weight::from_parts(34_490_000, 5546)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn prepare_staking_payouts() -> Weight {
        ...
        Weight::from_parts(58_430_000, 11670)
            .saturating_add(T::DbWeight::get().reads(6))
    ...
    fn get_rewardable_delegators(y: u32) -> Weight {
        ...
        Weight::from_parts(11_069_735, 5180)
            // Standard Error: 2_533
            .saturating_add(Weight::from_parts(128_697, 0).saturating_mul(y.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn select_top_candidates(x: u32, y: u32) -> Weight {
        ...
        Weight::from_parts(43_250_000, 13898)
            // Standard Error: 182_967
            .saturating_add(Weight::from_parts(30_359_281, 0).saturating_mul(x.into()))
            // Standard Error: 91_241
            .saturating_add(Weight::from_parts(2_857_843, 0).saturating_mul(y.into()))
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().reads((4_u64).saturating_mul(x.into())))
            .saturating_add(T::DbWeight::get().writes(2))
    ...
    fn pay_one_collator_reward(y: u32) -> Weight {
        ...
        Weight::from_parts(39_786_426, 16898)
            // Standard Error: 129_057
            .saturating_add(Weight::from_parts(22_159_064, 0).saturating_mul(y.into()))
            .saturating_add(T::DbWeight::get().reads(6))
    ...
    fn set_auto_compound(x: u32, y: u32) -> Weight {
        ...
        Weight::from_parts(53_869_963, 6134)
            // Standard Error: 1_713
            .saturating_add(Weight::from_parts(85_404, 0).saturating_mul(x.into()))
            // Standard Error: 5_128
            .saturating_add(Weight::from_parts(70_357, 0).saturating_mul(y.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    ...
    fn delegate_with_auto_compound(x: u32, y: u32, z: u32) -> Weight {
        ...
        Weight::from_parts(113_273_209, 127262)
            // Standard Error: 4_496
            .saturating_add(Weight::from_parts(250_836, 0).saturating_mul(x.into()))
            // Standard Error: 4_508
            .saturating_add(Weight::from_parts(38_880, 0).saturating_mul(y.into()))
            // Standard Error: 15_879
            .saturating_add(Weight::from_parts(321_534, 0).saturating_mul(z.into()))
            .saturating_add(T::DbWeight::get().reads(8))
            .saturating_add(T::DbWeight::get().writes(8))
    ...
    fn mint_collator_reward() -> Weight {
        ...
        Weight::from_parts(28_280_000, 2607)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
