...
impl<T: frame_system::Config> pallet_treasury::weights::WeightInfo for WeightInfo<T> {
    ...
    fn reject_proposal() -> Weight {
        Weight::from_ref_time(24_734_000)
            .saturating_add(T::DbWeight::get().reads(1))
    ...
    fn approve_proposal(p: u32) -> Weight {
        Weight::from_ref_time(10_189_000)
    ...
    fn remove_approval() -> Weight {
        Weight::from_ref_time(6_149_000)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn on_initialize_proposals(p: u32) -> Weight {
        Weight::from_ref_time(39_798_000)
            // Standard Error: 30_000
            .saturating_add(Weight::from_ref_time(17_861_000).saturating_mul(p.into()))
            .saturating_add(T::DbWeight::get().reads(2))
