...
impl<T: frame_system::Config> pallet_collective::weights::WeightInfo for WeightInfo<T> {
    ...
    fn set_members(m: u32, _n: u32, p: u32, ) -> Weight {
        ...
        Weight::from_parts(17_530_000, 1512)
            // Standard Error: 5_224_190
            .saturating_add(Weight::from_parts(13_381_315, 0).saturating_mul(m.into()))
            // Standard Error: 2_048_702
            .saturating_add(Weight::from_parts(5_220_006, 0).saturating_mul(p.into()))
    ...
    fn execute(b: u32, m: u32, ) -> Weight {
        ...
        Weight::from_parts(12_526_347, 1515)
            // Standard Error: 262
            .saturating_add(Weight::from_parts(1_775, 0).saturating_mul(b.into()))
            // Standard Error: 2_711
            .saturating_add(Weight::from_parts(5_101, 0).saturating_mul(m.into()))
    ...
    fn propose_execute(b: u32, m: u32, ) -> Weight {
        ...
        Weight::from_parts(14_334_431, 3495)
            // Standard Error: 76
            .saturating_add(Weight::from_parts(2_273, 0).saturating_mul(b.into()))
            // Standard Error: 787
            .saturating_add(Weight::from_parts(7_020, 0).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(2))
           .saturating_add(Weight::from_parts(0, 32).saturating_mul(m.into()))
    }
    /// Storage: `AdvisoryCommittee::Members` (r:1 w:0)
    ...
    fn propose_proposed(b: u32, m: u32, p: u32, ) -> Weight {
        ...
        Weight::from_parts(16_056_327, 3464)
            // Standard Error: 802
            .saturating_add(Weight::from_parts(949, 0).saturating_mul(b.into()))
            // Standard Error: 8_370
            .saturating_add(Weight::from_parts(13_367, 0).saturating_mul(m.into()))
            // Standard Error: 3_229
            .saturating_add(Weight::from_parts(145_039, 0).saturating_mul(p.into()))
    ...
    fn vote(_m: u32, ) -> Weight {
        ...
        Weight::from_parts(23_070_000, 11004)
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn close_early_disapproved(m: u32, p: u32, ) -> Weight {
        ...
        // Minimum execution time: 19_720 nanoseconds.
        Weight::from_parts(19_055_875, 3615)
            // Standard Error: 3_608
            .saturating_add(Weight::from_parts(5_312, 0).saturating_mul(m.into()))
            // Standard Error: 1_363
            .saturating_add(Weight::from_parts(132_874, 0).saturating_mul(p.into()))
    ...
    fn close_early_approved(b: u32, m: u32, p: u32, ) -> Weight {
        ...
        Weight::from_parts(22_558_167, 3092)
            // Standard Error: 3_088
            .saturating_add(Weight::from_parts(2_113, 0).saturating_mul(b.into()))
            // Standard Error: 32_883
            .saturating_add(Weight::from_parts(36_045, 0).saturating_mul(m.into()))
            // Standard Error: 12_428
            .saturating_add(Weight::from_parts(152_757, 0).saturating_mul(p.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    ...
    fn close_disapproved(m: u32, p: u32, ) -> Weight {
        ...
        Weight::from_parts(15_720_654, 3635)
            // Standard Error: 1_533
            .saturating_add(Weight::from_parts(65_156, 0).saturating_mul(m.into()))
            // Standard Error: 579
            .saturating_add(Weight::from_parts(153_720, 0).saturating_mul(p.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
           .saturating_add(Weight::from_parts(0, 64).saturating_mul(m.into()))
           .saturating_add(Weight::from_parts(0, 35).saturating_mul(p.into()))
    ...
    fn close_approved(b: u32, m: u32, p: u32, ) -> Weight {
        ...
        Weight::from_parts(20_484_223, 3112)
            // Standard Error: 4_501
            .saturating_add(Weight::from_parts(5_058, 0).saturating_mul(b.into()))
            // Standard Error: 47_926
            .saturating_add(Weight::from_parts(44_062, 0).saturating_mul(m.into()))
            // Standard Error: 18_113
            .saturating_add(Weight::from_parts(159_409, 0).saturating_mul(p.into()))
    ...
    fn disapprove_proposal(_p: u32, ) -> Weight {
        ...
        //  Measured:  `185 + p * (32 ±0)`
        //  Estimated: `9833`
        // Minimum execution time: 12_280 nanoseconds.
        Weight::from_parts(45_041_000, 9833)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(3))
    }
}
