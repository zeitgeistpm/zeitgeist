...
pub fn battery_park_config() -> Result<ChainSpec, String> {
    ...
    let wasm_binary = zeitgeist_runtime::WASM_BINARY.ok_or("Zeitgeist runtime wasm binary not available".to_string())?;
            ...
            battery_park_genesis(
                ...
                vec![
                    (
                        ...
                        hex!["e61786c6426b55a034f9c4b78dc57d4183927cef8e64b2e496225ed6fca41758"].unchecked_into(),
                    )
                ],
                // Sudo account
