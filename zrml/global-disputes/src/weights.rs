...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(o: u32, v: u32) -> Weight {
        ...
        //  Measured:  `581 + o * (33 ±0) + v * (32 ±0)`
        //  Estimated: `13631`
        // Minimum execution time: 58_630 nanoseconds.
        Weight::from_parts(70_092_958, 13631)
            // Standard Error: 73_330
            .saturating_add(Weight::from_parts(356_105, 0).saturating_mul(o.into()))
            // Standard Error: 12_896
            .saturating_add(Weight::from_parts(114_716, 0).saturating_mul(v.into()))
    ...
    fn unlock_vote_balance_set(l: u32, o: u32) -> Weight {
        ...
        // Minimum execution time: 38_041 nanoseconds.
        Weight::from_parts(46_882_976, 10497)
            // Standard Error: 47_099
            .saturating_add(Weight::from_parts(4_725_103, 0).saturating_mul(l.into()))
            // Standard Error: 247_202
            .saturating_add(Weight::from_parts(890_884, 0).saturating_mul(o.into()))
    ...
    fn unlock_vote_balance_remove(l: u32, _o: u32) -> Weight {
        ...
        Weight::from_parts(55_026_649, 10497)
            // Standard Error: 45_140
            .saturating_add(Weight::from_parts(4_559_687, 0).saturating_mul(l.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(l.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(Weight::from_parts(0, 2871).saturating_mul(l.into()))
    ...
    fn reward_outcome_owner_shared_possession(o: u32) -> Weight {
        ...
        // Minimum execution time: 77_830 nanoseconds.
        Weight::from_parts(63_317_800, 8574)
            // Standard Error: 328_030
            .saturating_add(Weight::from_parts(36_970_797, 0).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn reward_outcome_owner_paid_possession() -> Weight {
        ...
        Weight::from_parts(95_780_000, 10955)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: GlobalDisputes GlobalDisputesInfo (r:1 w:1)
    ...
    fn purge_outcomes(k: u32, _o: u32) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `480 + k * (122 ±0) + o * (32 ±0)`
        //  Estimated: `8611 + k * (2870 ±0)`
        // Minimum execution time: 96_590 nanoseconds.
        Weight::from_parts(16_892_762, 8611)
            // Standard Error: 75_754
            .saturating_add(Weight::from_parts(21_079_551, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn refund_vote_fees(k: u32, _o: u32) -> Weight {
        ...
        Weight::from_parts(90_779_105, 8611)
            // Standard Error: 72_050
            .saturating_add(Weight::from_parts(20_636_324, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(k.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(k.into())))
