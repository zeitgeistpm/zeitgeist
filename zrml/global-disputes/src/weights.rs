...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(o: u32, v: u32) -> Weight {
        ...
        //  Estimated: `5106`
        // Minimum execution time: 62_231 nanoseconds.
        Weight::from_parts(65_508_186, 5106)
            // Standard Error: 38_146
            .saturating_add(Weight::from_parts(182_593, 0).saturating_mul(o.into()))
            // Standard Error: 6_708
            .saturating_add(Weight::from_parts(106_698, 0).saturating_mul(v.into()))
    ...
    fn unlock_vote_balance_set(l: u32, o: u32) -> Weight {
        ...
        Weight::from_parts(28_743_451, 5106)
            // Standard Error: 19_359
            .saturating_add(Weight::from_parts(3_560_153, 0).saturating_mul(l.into()))
            // Standard Error: 101_607
            .saturating_add(Weight::from_parts(1_301_519, 0).saturating_mul(o.into()))
    ...
    fn unlock_vote_balance_remove(l: u32, o: u32) -> Weight {
        ...
        Weight::from_parts(30_351_174, 5106)
            // Standard Error: 15_548
            .saturating_add(Weight::from_parts(3_472_851, 0).saturating_mul(l.into()))
            // Standard Error: 81_605
            .saturating_add(Weight::from_parts(890_387, 0).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(l.into())))
    ...
    fn add_vote_outcome(_w: u32) -> Weight {
        ...
        //  Measured:  `680 + w * (32 ±0)`
        //  Estimated: `4159`
        // Minimum execution time: 82_711 nanoseconds.
        Weight::from_parts(87_752_771, 4159)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    ...
    fn reward_outcome_owner_shared_possession(o: u32) -> Weight {
        ...
        // Minimum execution time: 85_251 nanoseconds.
        Weight::from_parts(42_605_872, 3861)
            // Standard Error: 209_501
            .saturating_add(Weight::from_parts(49_858_228, 0).saturating_mul(o.into()))
    ...
    fn reward_outcome_owner_paid_possession() -> Weight {
        ...
        //  Measured:  `511`
        //  Estimated: `6204`
        // Minimum execution time: 83_652 nanoseconds.
        Weight::from_parts(86_052_000, 6204)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: `GlobalDisputes::GlobalDisputesInfo` (r:1 w:1)
    ...
    fn purge_outcomes(k: u32, _o: u32) -> Weight {
        ...
        Weight::from_parts(64_601_349, 6730)
            // Standard Error: 15_266
            .saturating_add(Weight::from_parts(7_091_397, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn refund_vote_fees(k: u32, _o: u32) -> Weight {
        ...
        //  Measured:  `385 + k * (90 ±0) + o * (32 ±0)`
        //  Estimated: `6730 + k * (2870 ±0)`
        // Minimum execution time: 45_201 nanoseconds.
        Weight::from_parts(58_776_592, 6730)
            // Standard Error: 15_598
            .saturating_add(Weight::from_parts(7_054_507, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(k.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(k.into())))
