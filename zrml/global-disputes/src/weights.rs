...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(o: u32, v: u32, ) -> Weight {
        ...
        //  Estimated: `5106`
        // Minimum execution time: 71_411 nanoseconds.
        Weight::from_parts(75_800_357, 5106)
            // Standard Error: 42_802
            .saturating_add(Weight::from_parts(144_224, 0).saturating_mul(o.into()))
            // Standard Error: 7_527
            .saturating_add(Weight::from_parts(79_621, 0).saturating_mul(v.into()))
    ...
    fn unlock_vote_balance_set(l: u32, o: u32, ) -> Weight {
        ...
        Weight::from_parts(37_571_794, 5106)
            // Standard Error: 20_059
            .saturating_add(Weight::from_parts(4_603_313, 0).saturating_mul(l.into()))
            // Standard Error: 105_282
            .saturating_add(Weight::from_parts(440_058, 0).saturating_mul(o.into()))
    ...
    fn unlock_vote_balance_remove(l: u32, o: u32, ) -> Weight {
        ...
        Weight::from_parts(36_222_813, 5106)
            // Standard Error: 26_536
            .saturating_add(Weight::from_parts(4_590_513, 0).saturating_mul(l.into()))
            // Standard Error: 139_276
            .saturating_add(Weight::from_parts(1_178_967, 0).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(l.into())))
    ...
    fn add_vote_outcome(w: u32, ) -> Weight {
        ...
        Weight::from_parts(98_755_060, 4173)
            // Standard Error: 46_515
            .saturating_add(Weight::from_parts(37_702, 0).saturating_mul(w.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    ...
    fn reward_outcome_owner_shared_possession(o: u32, ) -> Weight {
        ...
        // Minimum execution time: 92_313 nanoseconds.
        Weight::from_parts(45_932_648, 3861)
            // Standard Error: 233_595
            .saturating_add(Weight::from_parts(52_884_289, 0).saturating_mul(o.into()))
    ...
    fn reward_outcome_owner_paid_possession() -> Weight {
        ...
        Weight::from_parts(96_462_000, 6204)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: `GlobalDisputes::GlobalDisputesInfo` (r:1 w:1)
    ...
    fn purge_outcomes(k: u32, _o: u32, ) -> Weight {
        ...
        // Minimum execution time: 58_131 nanoseconds.
        Weight::from_parts(62_145_744, 6730)
            // Standard Error: 13_312
            .saturating_add(Weight::from_parts(7_895_643, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn refund_vote_fees(k: u32, _o: u32, ) -> Weight {
        ...
        Weight::from_parts(54_726_534, 6730)
            // Standard Error: 10_298
            .saturating_add(Weight::from_parts(7_814_077, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(k.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(k.into())))
