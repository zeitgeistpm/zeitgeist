...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(o: u32, v: u32) -> Weight {
        (77_234_000 as Weight)
            ...
            .saturating_add((122_000 as Weight).saturating_mul(o as Weight))
            // Standard Error: 0
    ...
    fn unlock_vote_balance_set(l: u32, o: u32) -> Weight {
        (21_110_000 as Weight)
            // Standard Error: 3_000
            .saturating_add((6_327_000 as Weight).saturating_mul(l as Weight))
            // Standard Error: 20_000
            .saturating_add((1_976_000 as Weight).saturating_mul(o as Weight))
    ...
    fn unlock_vote_balance_remove(l: u32, o: u32) -> Weight {
        (18_940_000 as Weight)
            // Standard Error: 3_000
            .saturating_add((6_247_000 as Weight).saturating_mul(l as Weight))
            // Standard Error: 19_000
            .saturating_add((1_822_000 as Weight).saturating_mul(o as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(l as Weight)))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
    }
    ...
    fn reward_outcome_owner_with_funds(o: u32) -> Weight {
        (51_857_000 as Weight)
            // Standard Error: 27_000
            .saturating_add((33_805_000 as Weight).saturating_mul(o as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
    ...
    fn purge_outcomes(k: u32, _o: u32) -> Weight {
        (0 as Weight)
            ...
            .saturating_add((23_452_000 as Weight).saturating_mul(k as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
