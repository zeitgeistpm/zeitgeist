...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(o: u32, v: u32) -> Weight {
        ...
        Weight::from_parts(64_123_584, 13631)
            // Standard Error: 20_943
            .saturating_add(Weight::from_ref_time(211_783).saturating_mul(o.into()))
            // Standard Error: 3_674
            .saturating_add(Weight::from_ref_time(73_843).saturating_mul(v.into()))
    ...
    fn unlock_vote_balance_set(l: u32, o: u32) -> Weight {
        ...
        Weight::from_parts(38_620_672, 10497)
            // Standard Error: 11_532
            .saturating_add(Weight::from_ref_time(4_005_759).saturating_mul(l.into()))
            // Standard Error: 64_559
            .saturating_add(Weight::from_ref_time(1_054_448).saturating_mul(o.into()))
    ...
    fn unlock_vote_balance_remove(l: u32, o: u32) -> Weight {
        ...
        Weight::from_parts(33_511_909, 10497)
            // Standard Error: 10_428
            .saturating_add(Weight::from_ref_time(3_811_407).saturating_mul(l.into()))
            // Standard Error: 58_378
            .saturating_add(Weight::from_ref_time(1_203_183).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(l.into())))
            .saturating_add(T::DbWeight::get().writes(2_u64))
            .saturating_add(Weight::from_proof_size(2871).saturating_mul(l.into()))
    ...
    fn add_vote_outcome(_w: u32) -> Weight {
        ...
        //  Measured:  `686 + w * (32 ±0)`
        //  Estimated: `11364`
        // Minimum execution time: 66_930 nanoseconds.
        Weight::from_parts(80_489_480, 11364)
            .saturating_add(T::DbWeight::get().reads(4_u64))
    ...
    fn reward_outcome_owner_shared_possession(o: u32) -> Weight {
        ...
        // Minimum execution time: 65_240 nanoseconds.
        Weight::from_parts(53_543_555, 8869)
            // Standard Error: 97_020
            .saturating_add(Weight::from_ref_time(29_345_233).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(3_u64))
    ...
    fn reward_outcome_owner_paid_possession() -> Weight {
        ...
        //  Measured:  `537`
        //  Estimated: `10955`
        // Minimum execution time: 64_330 nanoseconds.
        Weight::from_parts(77_110_000, 10955)
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    /// Storage: GlobalDisputes GlobalDisputesInfo (r:1 w:1)
    ...
    fn purge_outcomes(k: u32, _o: u32) -> Weight {
        ...
        Weight::from_parts(77_737_658, 8611)
            // Standard Error: 16_871
            .saturating_add(Weight::from_ref_time(17_798_938).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3_u64))
    ...
    fn refund_vote_fees(k: u32, _o: u32) -> Weight {
        ...
        Weight::from_parts(169_245_397, 8611)
            // Standard Error: 20_546
            .saturating_add(Weight::from_ref_time(17_882_530).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(k.into())))
            .saturating_add(T::DbWeight::get().writes(1_u64))
            .saturating_add(Weight::from_proof_size(2870).saturating_mul(k.into()))
