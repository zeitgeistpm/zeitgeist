...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn vote_on_outcome(_o: u32, v: u32) -> Weight {
        ...
        //  Measured:  `543 + o * (33 ±0) + v * (32 ±0)`
        //  Estimated: `13631`
        // Minimum execution time: 56_670 nanoseconds.
        Weight::from_parts(69_465_142, 13631)
            // Standard Error: 14_768
            .saturating_add(Weight::from_parts(86_839, 0).saturating_mul(v.into()))
    ...
    fn unlock_vote_balance_set(l: u32, o: u32) -> Weight {
        ...
        // Minimum execution time: 35_260 nanoseconds.
        Weight::from_parts(34_550_861, 10497)
            // Standard Error: 43_637
            .saturating_add(Weight::from_parts(4_439_605, 0).saturating_mul(l.into()))
            // Standard Error: 229_033
            .saturating_add(Weight::from_parts(1_586_966, 0).saturating_mul(o.into()))
    ...
    fn unlock_vote_balance_remove(l: u32, o: u32) -> Weight {
        ...
        Weight::from_parts(21_974_745, 10497)
            // Standard Error: 38_707
            .saturating_add(Weight::from_parts(4_502_385, 0).saturating_mul(l.into()))
            // Standard Error: 203_160
            .saturating_add(Weight::from_parts(1_872_956, 0).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(l.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(Weight::from_parts(0, 2871).saturating_mul(l.into()))
    ...
    fn add_vote_outcome(w: u32) -> Weight {
        ...
        //  Measured:  `723 + w * (32 ±0)`
        //  Estimated: `11499`
        // Minimum execution time: 67_910 nanoseconds.
        Weight::from_parts(81_338_878, 11499)
            // Standard Error: 96_089
            .saturating_add(Weight::from_parts(37_409, 0).saturating_mul(w.into()))
            .saturating_add(T::DbWeight::get().reads(4))
    ...
    fn reward_outcome_owner_shared_possession(o: u32) -> Weight {
        ...
        // Minimum execution time: 74_021 nanoseconds.
        Weight::from_parts(56_045_009, 8574)
            // Standard Error: 319_664
            .saturating_add(Weight::from_parts(31_254_358, 0).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn reward_outcome_owner_paid_possession() -> Weight {
        ...
        //  Measured:  `570`
        //  Estimated: `10955`
        // Minimum execution time: 73_720 nanoseconds.
        Weight::from_parts(90_400_000, 10955)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    /// Storage: GlobalDisputes GlobalDisputesInfo (r:1 w:1)
    ...
    fn purge_outcomes(k: u32, _o: u32) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `442 + k * (122 ±0) + o * (32 ±0)`
        //  Estimated: `8611 + k * (2870 ±0)`
        // Minimum execution time: 89_061 nanoseconds.
        Weight::from_parts(90_760_000, 8611)
            // Standard Error: 41_431
            .saturating_add(Weight::from_parts(18_137_023, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn refund_vote_fees(k: u32, _o: u32) -> Weight {
        ...
        //  Measured:  `442 + k * (122 ±0) + o * (32 ±0)`
        //  Estimated: `8611 + k * (2870 ±0)`
        // Minimum execution time: 85_100 nanoseconds.
        Weight::from_parts(37_928_811, 8611)
            // Standard Error: 79_913
            .saturating_add(Weight::from_parts(18_292_158, 0).saturating_mul(k.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(k.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(k.into())))
