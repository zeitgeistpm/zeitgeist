...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn buy(_n: u32) -> Weight {
        ...
        Weight::from_parts(3_933_000_000, 337938)
    ...
    fn sell(_n: u32) -> Weight {
        ...
        Weight::from_parts(4_503_000_000, 337938)
            .saturating_add(T::DbWeight::get().reads(262))
            .saturating_add(T::DbWeight::get().writes(261))
    }
    /// Storage: `NeoSwaps::Pools` (r:1 w:1)
    ...
    fn join_in_place(_n: u32) -> Weight {
        ...
        Weight::from_parts(2_559_000_000, 669662)
    ...
    fn join_reassigned(_n: u32) -> Weight {
        ...
        //  Estimated: `669662`
        // Minimum execution time: 235_000 nanoseconds.
        Weight::from_parts(2_571_000_000, 669662)
            .saturating_add(T::DbWeight::get().reads(259))
            .saturating_add(T::DbWeight::get().writes(257))
    }
    /// Storage: `NeoSwaps::Pools` (r:1 w:1)
    ...
    fn join_leaf(_n: u32) -> Weight {
        ...
        Weight::from_parts(2_532_000_000, 669662)
            .saturating_add(T::DbWeight::get().reads(259))
            .saturating_add(T::DbWeight::get().writes(257))
    }
    /// Storage: `NeoSwaps::Pools` (r:1 w:1)
    ...
    fn exit(_n: u32) -> Weight {
        ...
        //  Estimated: `669662`
        // Minimum execution time: 235_000 nanoseconds.
        Weight::from_parts(2_598_000_000, 669662)
            .saturating_add(T::DbWeight::get().reads(259))
            .saturating_add(T::DbWeight::get().writes(257))
    }
    /// Storage: `NeoSwaps::Pools` (r:1 w:1)
    ...
    fn withdraw_fees() -> Weight {
        ...
        Weight::from_parts(164_000_000, 156294)
    ...
    fn deploy_pool(_n: u32) -> Weight {
        ...
        Weight::from_parts(2_908_000_000, 669662)
    ...
    fn combo_sell(_n: u32) -> Weight {
        ...
        Weight::from_parts(14_057_000_000, 667050)
    ...
    fn deploy_combinatorial_pool(n: u32, m: u32) -> Weight {
        ...
        // Minimum execution time: 3_483_000 nanoseconds.
        Weight::from_parts(3_483_000_000, 11438)
            // Standard Error: 17_238_121_316
            .saturating_add(Weight::from_parts(59_694_255_855, 0).saturating_mul(n.into()))
            // Standard Error: 1_817_603_440
            .saturating_add(Weight::from_parts(113_116_666, 0).saturating_mul(m.into()))
    ...
    fn decision_market_oracle_evaluate() -> Weight {
        ...
        Weight::from_parts(46_000_000, 156294).saturating_add(T::DbWeight::get().reads(1))
    }
}
