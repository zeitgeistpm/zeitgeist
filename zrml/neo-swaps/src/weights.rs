...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn buy(n: u32) -> Weight {
        ...
        // Minimum execution time: 585_102 nanoseconds.
        Weight::from_parts(580_456_240, 148211)
            // Standard Error: 101_265
            .saturating_add(Weight::from_parts(27_359_358, 0).saturating_mul(n.into()))
    ...
    fn sell(n: u32) -> Weight {
        ...
        //  Estimated: `148211 + n * (2598 ±0)`
        // Minimum execution time: 468_861 nanoseconds.
        Weight::from_parts(414_696_511, 148211)
            // Standard Error: 95_356
            .saturating_add(Weight::from_parts(38_051_885, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes(5))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
    ...
    fn join_in_place(n: u32) -> Weight {
        ...
        // Minimum execution time: 595_362 nanoseconds.
        Weight::from_parts(440_618_005, 148211)
            // Standard Error: 273_538
            .saturating_add(Weight::from_parts(47_025_592, 0).saturating_mul(n.into()))
    ...
    fn join_reassigned(n: u32) -> Weight {
        ...
        //  Estimated: `148211 + n * (5196 ±0)`
        // Minimum execution time: 622_432 nanoseconds.
        Weight::from_parts(473_601_406, 148211)
            // Standard Error: 298_264
            .saturating_add(Weight::from_parts(47_682_394, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
    ...
    fn join_leaf(n: u32) -> Weight {
        ...
        //  Estimated: `148211 + n * (5196 ±0)`
        // Minimum execution time: 582_132 nanoseconds.
        Weight::from_parts(546_913_207, 148211)
            // Standard Error: 277_416
            .saturating_add(Weight::from_parts(46_923_622, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
    ...
    fn exit(n: u32) -> Weight {
        ...
        //  Estimated: `148211 + n * (5196 ±0)`
        // Minimum execution time: 623_772 nanoseconds.
        Weight::from_parts(514_882_760, 148211)
            // Standard Error: 282_318
            .saturating_add(Weight::from_parts(45_943_935, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
    ...
    fn withdraw_fees() -> Weight {
        ...
        //  Measured:  `137756`
        //  Estimated: `148211`
        // Minimum execution time: 595_752 nanoseconds.
        Weight::from_parts(668_402_000, 148211)
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn deploy_pool(n: u32) -> Weight {
        ...
        //  Measured:  `611 + n * (81 ±0)`
        //  Estimated: `148211 + n * (5196 ±0)`
        // Minimum execution time: 205_881 nanoseconds.
        Weight::from_parts(123_014_022, 148211)
            // Standard Error: 170_483
            .saturating_add(Weight::from_parts(55_591_115, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
