...
mod pallet {
        ...
        T: Config,
    {
        ...
        PoolExit(PoolAssetsEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
        /// Someone has (partially) exited a pool by removing subsidy. \[PoolAssetEvent, amount\]
        PoolExitSubsidy(PoolAssetEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
        /// Exits a pool given an exact amount of an asset. \[PoolAssetEvent\]
        PoolExitWithExactAssetAmount(
            PoolAssetEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>,
        ),
        ...
        PoolJoin(PoolAssetsEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
        /// Someone has joined a pool by providing subsidy. \[PoolAssetEvent, amount\]
        PoolJoinSubsidy(PoolAssetEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
        ...
        SwapExactAmountIn(SwapEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
        /// An exact amount of an asset is leaving the pool. \[SwapEvent\]
        SwapExactAmountOut(SwapEvent<<T as frame_system::Config>::AccountId, Asset<T::MarketId>, BalanceOf<T>>),
    }
