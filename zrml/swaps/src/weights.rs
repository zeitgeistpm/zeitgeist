...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_clean_up_pool_cpmm_categorical(a: u32) -> Weight {
        Weight::from_ref_time(25_333_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(294_000).saturating_mul(a.into()))
    ...
    // Storage: Swaps Pools (r:1 w:1)
    fn admin_clean_up_pool_cpmm_scalar() -> Weight {
        Weight::from_ref_time(22_333_000)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn apply_to_cached_pools_execute_arbitrage(a: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(933_426_000).saturating_mul(a.into()))
    ...
    fn apply_to_cached_pools_noop(a: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(3_438_000).saturating_mul(a.into()))
    ...
    fn destroy_pool_in_subsidy_phase(a: u32) -> Weight {
        Weight::from_ref_time(20_186_000)
            ...
            .saturating_add(Weight::from_ref_time(9_439_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn distribute_pool_share_rewards(a: u32, b: u32) -> Weight {
        Weight::from_ref_time(25_316_000)
            ...
            .saturating_add(Weight::from_ref_time(10_887_000).saturating_mul(a.into()))
            // Standard Error: 18_000
            .saturating_add(Weight::from_ref_time(16_348_000).saturating_mul(b.into()))
    ...
    fn end_subsidy_phase(a: u32, b: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(10_591_000).saturating_mul(a.into()))
            // Standard Error: 418_000
            .saturating_add(Weight::from_ref_time(50_291_000).saturating_mul(b.into()))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
    ...
    fn execute_arbitrage_buy_burn(a: u32) -> Weight {
        Weight::from_ref_time(31_946_000)
            // Standard Error: 9_000
            .saturating_add(Weight::from_ref_time(15_353_000).saturating_mul(a.into()))
    ...
    // Storage: Tokens TotalIssuance (r:1 w:1)
    fn execute_arbitrage_mint_sell(a: u32) -> Weight {
        Weight::from_ref_time(35_968_000)
            // Standard Error: 8_000
            .saturating_add(Weight::from_ref_time(14_347_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
    ...
    fn execute_arbitrage_skipped(a: u32) -> Weight {
        Weight::from_ref_time(14_082_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(2_260_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(a.into())))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    fn pool_exit(a: u32) -> Weight {
        Weight::from_ref_time(36_569_000)
            // Standard Error: 1_000
            .saturating_add(Weight::from_ref_time(11_401_000).saturating_mul(a.into()))
    ...
    // Storage: Tokens Accounts (r:1 w:1)
    fn pool_exit_subsidy() -> Weight {
        Weight::from_ref_time(37_487_000)
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn pool_exit_with_exact_asset_amount() -> Weight {
        Weight::from_ref_time(69_403_000)
    ...
    // Storage: Tokens Accounts (r:5 w:5)
    fn pool_join(a: u32) -> Weight {
        Weight::from_ref_time(32_481_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(10_527_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
    ...
    // Storage: Swaps PoolsCachedForArbitrage (r:0 w:1)
    fn pool_join_with_exact_pool_amount() -> Weight {
        Weight::from_ref_time(62_390_000)
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    // Storage: Swaps Pools (r:1 w:1)
    fn clean_up_pool_categorical_without_reward_distribution(a: u32) -> Weight {
        Weight::from_ref_time(5_716_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(182_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    // Storage: Swaps PoolsCachedForArbitrage (r:0 w:1)
    fn swap_exact_amount_in_cpmm() -> Weight {
        Weight::from_ref_time(81_560_000)
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    fn swap_exact_amount_in_rikiddo(a: u32) -> Weight {
        Weight::from_ref_time(68_347_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(7_471_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    ...
    // Storage: Swaps PoolsCachedForArbitrage (r:0 w:1)
    fn swap_exact_amount_out_cpmm() -> Weight {
        Weight::from_ref_time(81_909_000)
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    // Storage: Timestamp Now (r:1 w:0)
    fn swap_exact_amount_out_rikiddo(a: u32) -> Weight {
        Weight::from_ref_time(51_173_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(13_039_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    ...
    fn open_pool(a: u32) -> Weight {
        Weight::from_ref_time(12_594_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(261_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    // Storage: Swaps Pools (r:1 w:1)
    fn close_pool(a: u32) -> Weight {
        Weight::from_ref_time(11_446_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(210_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    // Storage: Swaps Pools (r:1 w:1)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn destroy_pool(a: u32) -> Weight {
        Weight::from_ref_time(15_607_000)
            // Standard Error: 1_000
            .saturating_add(Weight::from_ref_time(10_020_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
