...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_clean_up_pool_cpmm_categorical(a: u32) -> Weight {
        Weight::from_ref_time(53_892_000)
            // Standard Error: 4_000
            .saturating_add(Weight::from_ref_time(578_000).saturating_mul(a as u64))
    ...
    fn end_subsidy_phase(a: u32, b: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(31_081_000).saturating_mul(a as u64))
            // Standard Error: 1_184_000
            .saturating_add(Weight::from_ref_time(143_417_000).saturating_mul(b as u64))
    ...
    fn destroy_pool_in_subsidy_phase(a: u32) -> Weight {
        Weight::from_ref_time(36_793_000)
            // Standard Error: 60_000
            .saturating_add(Weight::from_ref_time(23_216_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
    ...
    fn distribute_pool_share_rewards(a: u32, b: u32) -> Weight {
        Weight::from_ref_time(161_905_000)
            // Standard Error: 224_000
            .saturating_add(Weight::from_ref_time(30_725_000).saturating_mul(a as u64))
            // Standard Error: 224_000
            .saturating_add(Weight::from_ref_time(42_701_000).saturating_mul(b as u64))
    ...
    fn pool_exit(a: u32) -> Weight {
        Weight::from_ref_time(78_562_000)
            // Standard Error: 52_000
            .saturating_add(Weight::from_ref_time(33_285_000).saturating_mul(a as u64))
    ...
    // Storage: Tokens Accounts (r:1 w:1)
    fn pool_exit_subsidy() -> Weight {
        Weight::from_ref_time(68_280_000)
            .saturating_add(T::DbWeight::get().reads(3 as u64))
    ...
    // Storage: System Account (r:1 w:0)
    fn pool_exit_with_exact_asset_amount() -> Weight {
        Weight::from_ref_time(138_900_000)
    ...
    // Storage: System Account (r:1 w:0)
    fn pool_exit_with_exact_pool_amount() -> Weight {
        Weight::from_ref_time(125_580_000)
            .saturating_add(T::DbWeight::get().reads(6 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    // Storage: Tokens Accounts (r:5 w:5)
    fn pool_join(a: u32) -> Weight {
        Weight::from_ref_time(44_225_000)
            // Standard Error: 57_000
            .saturating_add(Weight::from_ref_time(31_262_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(2 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    // Storage: Swaps SubsidyProviders (r:1 w:1)
    fn pool_join_subsidy() -> Weight {
        Weight::from_ref_time(63_780_000)
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().writes(3 as u64))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    // Storage: Tokens Accounts (r:3 w:3)
    fn pool_join_with_exact_asset_amount() -> Weight {
        Weight::from_ref_time(112_351_000)
    ...
    // Storage: Tokens Accounts (r:3 w:3)
    fn pool_join_with_exact_pool_amount() -> Weight {
        Weight::from_ref_time(113_751_000)
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Swaps Pools (r:1 w:1)
    fn clean_up_pool_categorical_without_reward_distribution(a: u32) -> Weight {
        Weight::from_ref_time(10_960_000)
            // Standard Error: 1_000
            .saturating_add(Weight::from_ref_time(364_000).saturating_mul(a as u64))
    ...
    fn swap_exact_amount_in_rikiddo(a: u32) -> Weight {
        Weight::from_ref_time(105_835_000)
            // Standard Error: 46_000
            .saturating_add(Weight::from_ref_time(24_265_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(6 as u64))
    ...
    // Storage: System Account (r:1 w:0)
    fn swap_exact_amount_out_cpmm() -> Weight {
        Weight::from_ref_time(168_530_000)
            .saturating_add(T::DbWeight::get().reads(6 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Swaps Pools (r:1 w:0)
    ...
    // Storage: Timestamp Now (r:1 w:0)
    fn swap_exact_amount_out_rikiddo(a: u32) -> Weight {
        Weight::from_ref_time(102_245_000)
            // Standard Error: 63_000
            .saturating_add(Weight::from_ref_time(42_828_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(6 as u64))
            .saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
    ...
    fn open_pool(a: u32) -> Weight {
        Weight::from_ref_time(26_760_000)
            ...
            .saturating_add(Weight::from_ref_time(573_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
    // Storage: Swaps Pools (r:1 w:1)
    fn close_pool(a: u32) -> Weight {
        Weight::from_ref_time(23_669_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(465_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
    // Storage: Swaps Pools (r:1 w:1)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn destroy_pool(a: u32) -> Weight {
        Weight::from_ref_time(9_744_000)
            // Standard Error: 47_000
            .saturating_add(Weight::from_ref_time(28_929_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    fn apply_to_cached_pools_execute_arbitrage(a: u32) -> Weight {
        Weight::from_ref_time(135_773_000)
            // Standard Error: 35_228_000
            .saturating_add(Weight::from_ref_time(3_291_495_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(45 as u64))
            .saturating_add(T::DbWeight::get().reads((67 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(44 as u64))
            .saturating_add(T::DbWeight::get().writes((66 as u64).saturating_mul(a as u64)))
    }
    // Storage: Swaps PoolsCachedForArbitrage (r:1 w:0)
    fn apply_to_cached_pools_noop(a: u32) -> Weight {
        Weight::from_ref_time(909_000)
            // Standard Error: 426_000
            .saturating_add(Weight::from_ref_time(12_215_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(a as u64)))
    ...
    // Storage: Tokens TotalIssuance (r:1 w:1)
    fn execute_arbitrage_buy_burn(a: u32) -> Weight {
        Weight::from_ref_time(63_109_000)
            // Standard Error: 1_027_000
            .saturating_add(Weight::from_ref_time(51_014_000).saturating_mul(a as u64))
    ...
    // Storage: Tokens TotalIssuance (r:1 w:1)
    fn execute_arbitrage_mint_sell(a: u32) -> Weight {
        Weight::from_ref_time(71_394_000)
            // Standard Error: 736_000
            .saturating_add(Weight::from_ref_time(45_508_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    fn execute_arbitrage_skipped(a: u32) -> Weight {
        Weight::from_ref_time(28_776_000)
            ...
            .saturating_add(Weight::from_ref_time(9_748_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(a as u64)))
    }
}
