...
//! DATE: 2023-04-20, STEPS: `10`, REPEAT: 1000, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn join_court(j: u32) -> Weight {
        Weight::from_ref_time(37_055_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(91_000).saturating_mul(j.into()))
    ...
    // Storage: Balances Locks (r:1 w:1)
    fn delegate(j: u32, d: u32) -> Weight {
        Weight::from_ref_time(47_313_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(122_000).saturating_mul(j.into()))
            // Standard Error: 61_000
            .saturating_add(Weight::from_ref_time(1_227_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn prepare_exit_court(j: u32) -> Weight {
        Weight::from_ref_time(22_189_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(85_000).saturating_mul(j.into()))
    ...
    fn vote(d: u32) -> Weight {
        Weight::from_ref_time(49_834_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(231_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    // Storage: Court SelectedDraws (r:1 w:1)
    fn denounce_vote(d: u32) -> Weight {
        Weight::from_ref_time(38_119_000)
            // Standard Error: 1_000
            .saturating_add(Weight::from_ref_time(220_000).saturating_mul(d.into()))
    ...
    // Storage: Court SelectedDraws (r:1 w:1)
    fn reveal_vote(d: u32) -> Weight {
        Weight::from_ref_time(73_151_000)
            // Standard Error: 9_000
            .saturating_add(Weight::from_ref_time(436_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn appeal(j: u32, a: u32, r: u32, _f: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(1_750_000).saturating_mul(j.into()))
            // Standard Error: 4_469_000
            .saturating_add(Weight::from_ref_time(835_228_000).saturating_mul(a.into()))
            // Standard Error: 180_000
            .saturating_add(Weight::from_ref_time(9_074_000).saturating_mul(r.into()))
    ...
    fn reassign_juror_stakes(d: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(66_657_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn handle_inflation(j: u32) -> Weight {
        Weight::from_ref_time(1_723_972_000)
            // Standard Error: 98_000
            .saturating_add(Weight::from_ref_time(14_481_000).saturating_mul(j.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn select_jurors(a: u32) -> Weight {
        Weight::from_ref_time(208_843_000)
            // Standard Error: 1_953_000
            .saturating_add(Weight::from_ref_time(387_998_000).saturating_mul(a.into()))
