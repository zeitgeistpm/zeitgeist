...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn join_court(j: u32) -> Weight {
        ...
        //  Estimated: `97487`
        // Minimum execution time: 70_120 nanoseconds.
        Weight::from_parts(104_617_890, 97487)
            // Standard Error: 1_533
            .saturating_add(Weight::from_parts(169_978, 0).saturating_mul(j.into()))
    ...
    fn delegate(j: u32, d: u32) -> Weight {
        ...
        // Minimum execution time: 111_671 nanoseconds.
        Weight::from_parts(91_977_310, 97487)
            // Standard Error: 1_492
            .saturating_add(Weight::from_parts(225_927, 0).saturating_mul(j.into()))
            // Standard Error: 323_881
            .saturating_add(Weight::from_parts(14_144_892, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(4))
    ...
    fn prepare_exit_court(j: u32) -> Weight {
        ...
        //  Estimated: `97487`
        // Minimum execution time: 39_270 nanoseconds.
        Weight::from_parts(70_821_465, 97487)
            // Standard Error: 1_114
            .saturating_add(Weight::from_parts(134_246, 0).saturating_mul(j.into()))
    ...
    fn exit_court_remove() -> Weight {
        ...
        //  Measured:  `276`
        //  Estimated: `4764`
        // Minimum execution time: 72_321 nanoseconds.
        Weight::from_parts(74_920_000, 4764)
    ...
    fn exit_court_set() -> Weight {
        ...
        Weight::from_parts(61_800_000, 4764)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn vote(d: u32) -> Weight {
        ...
        //  Measured:  `387 + d * (53 ±0)`
        //  Estimated: `153439`
        // Minimum execution time: 75_670 nanoseconds.
        Weight::from_parts(82_899_200, 153439)
            // Standard Error: 1_081
            .saturating_add(Weight::from_parts(168_916, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn denounce_vote(d: u32) -> Weight {
        ...
        Weight::from_parts(122_229_287, 153439)
            // Standard Error: 2_413
            .saturating_add(Weight::from_parts(214_002, 0).saturating_mul(d.into()))
    ...
    fn reveal_vote(d: u32) -> Weight {
        ...
        //  Estimated: `153439`
        // Minimum execution time: 123_340 nanoseconds.
        Weight::from_parts(143_162_366, 153439)
            // Standard Error: 1_630
            .saturating_add(Weight::from_parts(166_050, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn appeal(j: u32, a: u32, _r: u32, _f: u32) -> Weight {
        ...
        // Minimum execution time: 5_533_132 nanoseconds.
        Weight::from_parts(6_091_374_000, 268138)
            // Standard Error: 119_001
            .saturating_add(Weight::from_parts(10_513_554, 0).saturating_mul(j.into()))
            // Standard Error: 41_432_880
            .saturating_add(Weight::from_parts(6_976_024_571, 0).saturating_mul(a.into()))
    ...
    fn reassign_court_stakes(d: u32) -> Weight {
        ...
        // Minimum execution time: 203_641 nanoseconds.
        Weight::from_parts(249_281_000, 153439)
            // Standard Error: 171_943
            .saturating_add(Weight::from_parts(126_319_071, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn set_inflation() -> Weight {
        ...
        Weight::from_parts(20_320_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn handle_inflation(j: u32) -> Weight {
        ...
        Weight::from_parts(55_571_000, 97487)
            // Standard Error: 42_436
            .saturating_add(Weight::from_parts(34_908_020, 0).saturating_mul(j.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn select_participants(a: u32) -> Weight {
        ...
        // Minimum execution time: 2_334_927 nanoseconds.
        Weight::from_parts(2_046_084_164, 97487)
            // Standard Error: 61_887_211
            .saturating_add(Weight::from_parts(4_470_109_395, 0).saturating_mul(a.into()))
    ...
    fn on_dispute(j: u32, r: u32) -> Weight {
        ...
        // Minimum execution time: 458_771 nanoseconds.
        Weight::from_parts(545_196_348, 97487)
            // Standard Error: 5_074
            .saturating_add(Weight::from_parts(344_054, 0).saturating_mul(j.into()))
            // Standard Error: 78_650
            .saturating_add(Weight::from_parts(727_968, 0).saturating_mul(r.into()))
    ...
    fn on_resolution(d: u32) -> Weight {
        ...
        //  Estimated: `153439 + d * (2726 ±0)`
        // Minimum execution time: 73_910 nanoseconds.
        Weight::from_parts(77_041_000, 153439)
            // Standard Error: 27_015
            .saturating_add(Weight::from_parts(10_592_807, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(1))
    ...
    fn exchange(a: u32) -> Weight {
        ...
        Weight::from_parts(34_027_716, 3814)
            // Standard Error: 193_772
            .saturating_add(Weight::from_parts(45_190_549, 0).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn get_auto_resolve() -> Weight {
        ...
        Weight::from_parts(22_610_000, 3814).saturating_add(T::DbWeight::get().reads(2))
    }
    /// Storage: `Court::MarketIdToCourtId` (r:1 w:0)
    /// Proof: `Court::MarketIdToCourtId` (`max_values`: None, `max_size`: Some(40), added: 2515, mode: `MaxEncodedLen`)
    /// Storage: `Court::CourtPool` (r:1 w:0)
    ...
    fn has_failed() -> Weight {
        ...
        Weight::from_parts(71_241_000, 97487).saturating_add(T::DbWeight::get().reads(5))
    }
    /// Storage: `Court::MarketIdToCourtId` (r:1 w:0)
    /// Proof: `Court::MarketIdToCourtId` (`max_values`: None, `max_size`: Some(40), added: 2515, mode: `MaxEncodedLen`)
    /// Storage: `Court::Courts` (r:1 w:1)
    ...
    fn on_global_dispute(_a: u32, d: u32) -> Weight {
        ...
        //  Estimated: `153439 + d * (2726 ±0)`
        // Minimum execution time: 49_460 nanoseconds.
        Weight::from_parts(53_661_000, 153439)
            // Standard Error: 16_081
            .saturating_add(Weight::from_parts(10_876_738, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(d.into())))
    ...
    fn clear(d: u32) -> Weight {
        ...
        //  Estimated: `153439 + d * (2726 ±0)`
        // Minimum execution time: 47_960 nanoseconds.
        Weight::from_parts(51_290_000, 153439)
            // Standard Error: 19_628
            .saturating_add(Weight::from_parts(10_330_139, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(d.into())))
