...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn join_court(j: u32) -> Weight {
        ...
        //  Estimated: `97487`
        // Minimum execution time: 48_131 nanoseconds.
        Weight::from_parts(58_645_216, 97487)
            // Standard Error: 481
            .saturating_add(Weight::from_parts(91_503, 0).saturating_mul(j.into()))
    ...
    fn delegate(j: u32, d: u32) -> Weight {
        ...
        Weight::from_parts(59_006_337, 97487)
            // Standard Error: 797
            .saturating_add(Weight::from_parts(119_447, 0).saturating_mul(j.into()))
            // Standard Error: 173_051
            .saturating_add(Weight::from_parts(6_411_124, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(4))
    ...
    fn prepare_exit_court(j: u32) -> Weight {
        ...
        Weight::from_parts(34_250_494, 97487)
            // Standard Error: 386
            .saturating_add(Weight::from_parts(74_378, 0).saturating_mul(j.into()))
    ...
    fn exit_court_remove() -> Weight {
        ...
        Weight::from_parts(48_881_000, 4764)
    ...
    fn exit_court_set() -> Weight {
        ...
        //  Measured:  `276`
        //  Estimated: `4764`
        // Minimum execution time: 38_071 nanoseconds.
        Weight::from_parts(38_981_000, 4764)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    ...
    fn vote(d: u32) -> Weight {
        ...
        //  Measured:  `387 + d * (53 ±0)`
        //  Estimated: `153439`
        // Minimum execution time: 37_181 nanoseconds.
        Weight::from_parts(40_417_243, 153439)
            // Standard Error: 673
            .saturating_add(Weight::from_parts(103_433, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn denounce_vote(d: u32) -> Weight {
        ...
        Weight::from_parts(58_373_904, 153439)
            // Standard Error: 959
            .saturating_add(Weight::from_parts(127_701, 0).saturating_mul(d.into()))
    ...
    fn reveal_vote(d: u32) -> Weight {
        ...
        //  Estimated: `153439`
        // Minimum execution time: 63_713 nanoseconds.
        Weight::from_parts(67_369_591, 153439)
            // Standard Error: 1_161
            .saturating_add(Weight::from_parts(108_525, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn appeal(j: u32, a: u32, _r: u32, _f: u32) -> Weight {
        ...
        // Minimum execution time: 3_408_406 nanoseconds.
        Weight::from_parts(3_537_789_000, 268138)
            // Standard Error: 64_781
            .saturating_add(Weight::from_parts(5_888_653, 0).saturating_mul(j.into()))
            // Standard Error: 22_555_191
            .saturating_add(Weight::from_parts(4_070_079_883, 0).saturating_mul(a.into()))
    ...
    fn reassign_court_stakes(d: u32) -> Weight {
        ...
        // Minimum execution time: 158_183 nanoseconds.
        Weight::from_parts(162_203_000, 153439)
            // Standard Error: 105_265
            .saturating_add(Weight::from_parts(83_990_484, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
    ...
    fn set_inflation() -> Weight {
        ...
        Weight::from_parts(12_040_000, 0).saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn handle_inflation(j: u32) -> Weight {
        ...
        Weight::from_parts(34_311_000, 97487)
            // Standard Error: 26_785
            .saturating_add(Weight::from_parts(22_440_514, 0).saturating_mul(j.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn select_participants(a: u32) -> Weight {
        ...
        // Minimum execution time: 1_526_253 nanoseconds.
        Weight::from_parts(1_239_510_651, 97487)
            // Standard Error: 37_774_441
            .saturating_add(Weight::from_parts(2_669_908_982, 0).saturating_mul(a.into()))
    ...
    fn on_dispute(j: u32, r: u32) -> Weight {
        ...
        // Minimum execution time: 293_826 nanoseconds.
        Weight::from_parts(336_311_490, 97487)
            // Standard Error: 3_346
            .saturating_add(Weight::from_parts(161_071, 0).saturating_mul(j.into()))
            // Standard Error: 51_862
            .saturating_add(Weight::from_parts(188_623, 0).saturating_mul(r.into()))
    ...
    fn on_resolution(d: u32) -> Weight {
        ...
        //  Estimated: `153439 + d * (2726 ±0)`
        // Minimum execution time: 41_451 nanoseconds.
        Weight::from_parts(42_181_000, 153439)
            // Standard Error: 10_436
            .saturating_add(Weight::from_parts(6_449_107, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(1))
    ...
    fn exchange(a: u32) -> Weight {
        ...
        Weight::from_parts(16_014_502, 3814)
            // Standard Error: 66_851
            .saturating_add(Weight::from_parts(29_337_882, 0).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn get_auto_resolve() -> Weight {
        ...
        Weight::from_parts(12_530_000, 3814).saturating_add(T::DbWeight::get().reads(2))
    }
    /// Storage: `Court::MarketIdToCourtId` (r:1 w:0)
    /// Proof: `Court::MarketIdToCourtId` (`max_values`: None, `max_size`: Some(40), added: 2515, mode: `MaxEncodedLen`)
    /// Storage: `Court::CourtPool` (r:1 w:0)
    ...
    fn has_failed() -> Weight {
        ...
        Weight::from_parts(33_700_000, 97487).saturating_add(T::DbWeight::get().reads(5))
    }
    /// Storage: `Court::MarketIdToCourtId` (r:1 w:0)
    /// Proof: `Court::MarketIdToCourtId` (`max_values`: None, `max_size`: Some(40), added: 2515, mode: `MaxEncodedLen`)
    /// Storage: `Court::Courts` (r:1 w:1)
    ...
    fn on_global_dispute(_a: u32, d: u32) -> Weight {
        ...
        Weight::from_parts(667_529, 153439)
            // Standard Error: 16_602
            .saturating_add(Weight::from_parts(6_690_530, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(d.into())))
    ...
    fn clear(d: u32) -> Weight {
        ...
        Weight::from_parts(23_680_000, 153439)
            // Standard Error: 11_415
            .saturating_add(Weight::from_parts(6_376_308, 0).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(d.into())))
            .saturating_add(T::DbWeight::get().writes(2))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(d.into())))
