...
//! DATE: 2023-08-03, STEPS: `10`, REPEAT: 1000, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn authorize_market_outcome_first_report(m: u32) -> Weight {
        Weight::from_ref_time(50_720_068)
            // Standard Error: 2_573
            .saturating_add(Weight::from_ref_time(88_116).saturating_mul(m.into()))
    ...
    // Storage: Authorized AuthorizedOutcomeReports (r:1 w:1)
    fn authorize_market_outcome_existing_report() -> Weight {
        Weight::from_ref_time(39_720_000)
