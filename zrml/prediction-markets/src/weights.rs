...
//! DATE: 2022-06-14, STEPS: `10`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_destroy_disputed_market(a: u32, b: u32, c: u32) -> Weight {
        (0 as Weight)
            // Standard Error: 4_418_000
            .saturating_add((97_981_000 as Weight).saturating_mul(a as Weight))
            // Standard Error: 4_418_000
            .saturating_add((11_994_000 as Weight).saturating_mul(b as Weight))
            // Standard Error: 5_773_000
            .saturating_add((95_965_000 as Weight).saturating_mul(c as Weight))
    ...
    fn admin_destroy_reported_market(a: u32, b: u32, c: u32) -> Weight {
        (0 as Weight)
            // Standard Error: 3_791_000
            .saturating_add((90_478_000 as Weight).saturating_mul(a as Weight))
            // Standard Error: 3_791_000
            .saturating_add((7_290_000 as Weight).saturating_mul(b as Weight))
            // Standard Error: 4_954_000
            .saturating_add((95_812_000 as Weight).saturating_mul(c as Weight))
            .saturating_add(T::DbWeight::get().reads(8 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(b as Weight)))
    ...
    fn buy_complete_set(a: u32) -> Weight {
        (98_356_000 as Weight)
            // Standard Error: 2_845_000
            .saturating_add((30_617_000 as Weight).saturating_mul(a as Weight))
    ...
    fn deploy_swap_pool_for_market(a: u32) -> Weight {
        (180_789_000 as Weight)
            // Standard Error: 3_153_000
            .saturating_add((42_933_000 as Weight).saturating_mul(a as Weight))
    ...
    fn dispute(_a: u32) -> Weight {
        (21_738_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: Balances Reserves (r:1 w:1)
    // Storage: MarketCommons Markets (r:1 w:1)
    fn do_reject_market() -> Weight {
    ...
    fn internal_resolve_categorical_reported(_a: u32, _b: u32, _c: u32) -> Weight {
        (22_168_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_categorical_disputed(_a: u32, _b: u32, _c: u32, _d: u32) -> Weight {
        (24_731_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_scalar_reported() -> Weight {
        (19_000_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_scalar_disputed(_d: u32) -> Weight {
        (16_625_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: Timestamp Now (r:1 w:0)
    ...
    fn process_subsidy_collecting_markets_raw(a: u32) -> Weight {
        (9_773_000 as Weight)
            ...
            .saturating_add((400_000 as Weight).saturating_mul(a as Weight))
    ...
    fn sell_complete_set(a: u32) -> Weight {
        (72_050_000 as Weight)
            // Standard Error: 2_386_000
            .saturating_add((39_575_000 as Weight).saturating_mul(a as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
            .saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
            .saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(a as Weight)))
