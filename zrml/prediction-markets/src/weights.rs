...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_move_market_to_resolved_scalar_disputed(r: u32, d: u32) -> Weight {
        Weight::from_ref_time(56_260_000)
            ...
            .saturating_add(Weight::from_ref_time(10_880_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(8))
    ...
    fn admin_move_market_to_resolved_categorical_disputed(r: u32, d: u32) -> Weight {
        Weight::from_ref_time(93_329_000)
            ...
            .saturating_add(Weight::from_ref_time(10_788_000).saturating_mul(d.into()))
    ...
    fn dispute_authorized(d: u32, b: u32) -> Weight {
        Weight::from_ref_time(34_018_000)
            // Standard Error: 6_000
            .saturating_add(Weight::from_ref_time(999_000).saturating_mul(d.into()))
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(21_000).saturating_mul(b.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(4))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    fn internal_resolve_categorical_disputed(d: u32) -> Weight {
        Weight::from_ref_time(72_294_000)
            ...
            .saturating_add(Weight::from_ref_time(8_150_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().writes(4))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    fn internal_resolve_scalar_disputed(d: u32) -> Weight {
        Weight::from_ref_time(36_011_000)
            // Standard Error: 27_000
            .saturating_add(Weight::from_ref_time(8_087_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: Timestamp Now (r:1 w:0)
    ...
    fn report(m: u32) -> Weight {
        Weight::from_ref_time(22_398_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(2_000).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
