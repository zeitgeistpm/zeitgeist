...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_destroy_disputed_market(a: u32, b: u32, c: u32) -> Weight {
        (0 as Weight)
            ...
            .saturating_add((77_941_000 as Weight).saturating_mul(a as Weight))
            // Standard Error: 204_000
            .saturating_add((81_044_000 as Weight).saturating_mul(c as Weight))
    ...
    fn admin_destroy_reported_market(a: u32, b: u32, c: u32) -> Weight {
        (0 as Weight)
            ...
            .saturating_add((79_076_000 as Weight).saturating_mul(a as Weight))
            // Standard Error: 105_000
            .saturating_add((5_057_000 as Weight).saturating_mul(b as Weight))
            // Standard Error: 138_000
            .saturating_add((81_329_000 as Weight).saturating_mul(c as Weight))
            .saturating_add(T::DbWeight::get().reads(7 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(b as Weight)))
    ...
    fn buy_complete_set(a: u32) -> Weight {
        (102_650_000 as Weight)
            ...
            .saturating_add((34_699_000 as Weight).saturating_mul(a as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
    ...
    fn deploy_swap_pool_for_market(a: u32) -> Weight {
        (173_765_000 as Weight)
            // Standard Error: 122_000
            .saturating_add((51_364_000 as Weight).saturating_mul(a as Weight))
            .saturating_add(T::DbWeight::get().reads(7 as Weight))
            .saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(a as Weight)))
    ...
    // Storage: MarketCommons Markets (r:1 w:1)
    fn handle_expired_advised_market() -> Weight {
        (85_490_000 as Weight)
            .saturating_add(T::DbWeight::get().reads(2 as Weight))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_categorical_reported(a: u32, _b: u32, _c: u32) -> Weight {
        (17_324_000 as Weight)
    ...
    fn internal_resolve_categorical_disputed(a: u32, _b: u32, _c: u32, d: u32) -> Weight {
        (17_974_000 as Weight)
            ...
            // Standard Error: 4_000
            .saturating_add((33_000 as Weight).saturating_mul(d as Weight))
            .saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_scalar_reported() -> Weight {
        (17_770_000 as Weight).saturating_add(T::DbWeight::get().reads(2 as Weight))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    // Storage: PredictionMarkets Disputes (r:1 w:0)
    fn internal_resolve_scalar_disputed(d: u32) -> Weight {
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn sell_complete_set(a: u32) -> Weight {
        (97_188_000 as Weight)
            // Standard Error: 106_000
            .saturating_add((40_221_000 as Weight).saturating_mul(a as Weight))
            .saturating_add(T::DbWeight::get().reads(3 as Weight))
            .saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(a as Weight)))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
            .saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(a as Weight)))
