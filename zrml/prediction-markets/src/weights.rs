...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn admin_destroy_disputed_market(a: u32, _d: u32, o: u32, c: u32, r: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(32_618_000).saturating_mul(a as u64))
            // Standard Error: 53_000
            .saturating_add(Weight::from_ref_time(445_000).saturating_mul(o as u64))
            // Standard Error: 53_000
            .saturating_add(Weight::from_ref_time(933_000).saturating_mul(c as u64))
            // Standard Error: 53_000
            .saturating_add(Weight::from_ref_time(1_231_000).saturating_mul(r as u64))
    ...
    fn admin_destroy_reported_market(a: u32, o: u32, c: u32, r: u32) -> Weight {
        Weight::from_ref_time(0)
            ...
            .saturating_add(Weight::from_ref_time(32_741_000).saturating_mul(a as u64))
            // Standard Error: 50_000
            .saturating_add(Weight::from_ref_time(1_465_000).saturating_mul(o as u64))
            // Standard Error: 50_000
            .saturating_add(Weight::from_ref_time(1_069_000).saturating_mul(c as u64))
            // Standard Error: 50_000
            .saturating_add(Weight::from_ref_time(210_000).saturating_mul(r as u64))
    ...
    fn admin_move_market_to_closed(o: u32, c: u32) -> Weight {
        Weight::from_ref_time(53_510_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(2_000).saturating_mul(o as u64))
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(24_000).saturating_mul(c as u64))
    ...
    // Storage: MarketCommons MarketPool (r:1 w:0)
    fn admin_move_market_to_resolved_scalar_reported(r: u32) -> Weight {
        Weight::from_ref_time(89_742_000)
            // Standard Error: 5_000
            .saturating_add(Weight::from_ref_time(36_000).saturating_mul(r as u64))
    ...
    // Storage: Swaps Pools (r:1 w:1)
    fn admin_move_market_to_resolved_categorical_reported(r: u32) -> Weight {
        Weight::from_ref_time(155_062_000)
            // Standard Error: 8_000
            .saturating_add(Weight::from_ref_time(155_000).saturating_mul(r as u64))
    ...
    fn admin_move_market_to_resolved_scalar_disputed(_r: u32, d: u32) -> Weight {
        Weight::from_ref_time(119_367_000)
            // Standard Error: 162_000
            .saturating_add(Weight::from_ref_time(28_533_000).saturating_mul(d as u64))
            .saturating_add(T::DbWeight::get().reads(7 as u64))
    ...
    // Storage: Swaps Pools (r:1 w:1)
    fn admin_move_market_to_resolved_categorical_disputed(r: u32, d: u32) -> Weight {
        Weight::from_ref_time(166_932_000)
            // Standard Error: 14_000
            .saturating_add(Weight::from_ref_time(348_000).saturating_mul(r as u64))
            // Standard Error: 198_000
            .saturating_add(Weight::from_ref_time(30_863_000).saturating_mul(d as u64))
            .saturating_add(T::DbWeight::get().reads(8 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(d as u64)))
    ...
    // Storage: Balances Reserves (r:1 w:1)
    fn approve_market() -> Weight {
        Weight::from_ref_time(51_730_000)
    ...
    fn request_edit(_r: u32) -> Weight {
        Weight::from_ref_time(41_274_000)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn buy_complete_set(a: u32) -> Weight {
        Weight::from_ref_time(78_198_000)
            // Standard Error: 30_000
            .saturating_add(Weight::from_ref_time(24_549_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(2 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
    ...
    fn create_market(_m: u32) -> Weight {
        Weight::from_ref_time(88_764_000)
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
    // Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
    ...
    fn edit_market(_m: u32) -> Weight {
        Weight::from_ref_time(62_015_000)
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
    ...
    fn deploy_swap_pool_for_market_future_pool(a: u32, _o: u32) -> Weight {
        Weight::from_ref_time(122_276_000)
            // Standard Error: 62_000
            .saturating_add(Weight::from_ref_time(40_018_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(8 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(7 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    // Storage: Swaps Pools (r:0 w:1)
    fn deploy_swap_pool_for_market_open_pool(a: u32) -> Weight {
        Weight::from_ref_time(157_360_000)
            // Standard Error: 56_000
            .saturating_add(Weight::from_ref_time(39_371_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(7 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(6 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    fn start_global_dispute(m: u32) -> Weight {
        Weight::from_ref_time(89_164_000)
            // Standard Error: 0
    ...
    fn dispute_authorized(_d: u32, b: u32) -> Weight {
        Weight::from_ref_time(77_511_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(95_000).saturating_mul(b as u64))
            .saturating_add(T::DbWeight::get().reads(4 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    // Storage: MarketCommons Markets (r:1 w:1)
    fn internal_resolve_categorical_reported() -> Weight {
        Weight::from_ref_time(159_021_000)
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    // Storage: System Account (r:1 w:1)
    fn internal_resolve_categorical_disputed(d: u32) -> Weight {
        Weight::from_ref_time(166_292_000)
            // Standard Error: 141_000
            .saturating_add(Weight::from_ref_time(18_708_000).saturating_mul(d as u64))
            .saturating_add(T::DbWeight::get().reads(6 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    // Storage: MarketCommons Markets (r:1 w:1)
    fn internal_resolve_scalar_reported() -> Weight {
        Weight::from_ref_time(74_830_000)
            .saturating_add(T::DbWeight::get().reads(4 as u64))
            .saturating_add(T::DbWeight::get().writes(3 as u64))
    }
    // Storage: Balances Reserves (r:1 w:1)
    ...
    // Storage: System Account (r:1 w:1)
    fn internal_resolve_scalar_disputed(d: u32) -> Weight {
        Weight::from_ref_time(89_741_000)
            // Standard Error: 78_000
            .saturating_add(Weight::from_ref_time(20_344_000).saturating_mul(d as u64))
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    // Storage: Timestamp Now (r:1 w:0)
    ...
    // Storage: PredictionMarkets MarketIdsPerDisputeBlock (r:1 w:1)
    fn on_initialize_resolve_overhead() -> Weight {
        Weight::from_ref_time(43_390_000)
    ...
    fn process_subsidy_collecting_markets_raw(a: u32) -> Weight {
        Weight::from_ref_time(5_033_000)
            ...
            .saturating_add(Weight::from_ref_time(258_000).saturating_mul(a as u64))
    ...
    // Storage: Tokens TotalIssuance (r:1 w:1)
    fn redeem_shares_categorical() -> Weight {
        Weight::from_ref_time(118_300_000)
            .saturating_add(T::DbWeight::get().reads(4 as u64))
            .saturating_add(T::DbWeight::get().writes(3 as u64))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn redeem_shares_scalar() -> Weight {
        Weight::from_ref_time(140_541_000)
            .saturating_add(T::DbWeight::get().reads(6 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    fn reject_market(c: u32, o: u32, r: u32) -> Weight {
        Weight::from_ref_time(70_584_000)
            ...
            .saturating_add(Weight::from_ref_time(93_000).saturating_mul(c as u64))
            // Standard Error: 275_000
            .saturating_add(Weight::from_ref_time(118_000).saturating_mul(o as u64))
            // Standard Error: 16_000
            .saturating_add(Weight::from_ref_time(12_000).saturating_mul(r as u64))
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(6 as u64))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    // Storage: PredictionMarkets MarketIdsPerReportBlock (r:1 w:1)
    fn report(m: u32) -> Weight {
        Weight::from_ref_time(44_948_000)
            // Standard Error: 1_000
            .saturating_add(Weight::from_ref_time(29_000).saturating_mul(m as u64))
            .saturating_add(T::DbWeight::get().reads(3 as u64))
            .saturating_add(T::DbWeight::get().writes(2 as u64))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn sell_complete_set(a: u32) -> Weight {
        Weight::from_ref_time(37_982_000)
            // Standard Error: 44_000
            .saturating_add(Weight::from_ref_time(31_579_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(2 as u64))
            .saturating_add(T::DbWeight::get().reads((2 as u64).saturating_mul(a as u64)))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
            .saturating_add(T::DbWeight::get().writes((2 as u64).saturating_mul(a as u64)))
    ...
    // Storage: Swaps Pools (r:0 w:1)
    fn start_subsidy(a: u32) -> Weight {
        Weight::from_ref_time(52_957_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(207_000).saturating_mul(a as u64))
            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
    // Storage: PredictionMarkets MarketIdsPerOpenBlock (r:1 w:1)
    ...
    // Storage: PredictionMarkets MarketIdsPerOpenTimeFrame (r:1 w:1)
    fn market_status_manager(b: u32, f: u32) -> Weight {
        Weight::from_ref_time(6_247_000)
            // Standard Error: 25_000
            .saturating_add(Weight::from_ref_time(6_396_000).saturating_mul(b as u64))
            // Standard Error: 25_000
            .saturating_add(Weight::from_ref_time(6_820_000).saturating_mul(f as u64))
            .saturating_add(T::DbWeight::get().reads(2 as u64))
    ...
    // Storage: PredictionMarkets MarketIdsPerDisputeBlock (r:1 w:1)
    fn market_resolution_manager(r: u32, d: u32) -> Weight {
        Weight::from_ref_time(29_193_000)
            // Standard Error: 23_000
            .saturating_add(Weight::from_ref_time(6_200_000).saturating_mul(r as u64))
            // Standard Error: 23_000
            .saturating_add(Weight::from_ref_time(6_182_000).saturating_mul(d as u64))
            .saturating_add(T::DbWeight::get().reads(2 as u64))
