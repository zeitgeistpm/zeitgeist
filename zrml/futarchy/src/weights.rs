...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn submit_proposal() -> Weight {
        ...
        Weight::from_parts(14_500_000, 4726)
    ...
    fn maybe_schedule_proposal() -> Weight {
        ...
        Weight::from_parts(10_550_000, 112539)
    ...
    fn take_proposals(n: u32) -> Weight {
        ...
        Weight::from_parts(5_757_222, 4726)
            // Standard Error: 3_602
            .saturating_add(Weight::from_parts(274_609, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
