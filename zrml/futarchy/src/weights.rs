...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    fn submit_proposal() -> Weight {
        ...
        Weight::from_parts(26_420_000, 4726)
    ...
    fn maybe_schedule_proposal() -> Weight {
        ...
        //  Measured:  `3`
        //  Estimated: `112539`
        // Minimum execution time: 17_271 nanoseconds.
        Weight::from_parts(18_110_000, 112539)
    ...
    fn take_proposals(n: u32, ) -> Weight {
        ...
        Weight::from_parts(12_662_885, 4726)
            // Standard Error: 25_307
            .saturating_add(Weight::from_parts(469_369, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
