...
export POLKADOT_IMAGE="parity/polkadot:v0.9.3"
...
curl -o $RELAY_CHAIN_SPEC_FILE https://raw.githubusercontent.com/paritytech/polkadot/release-v0.9.3/node/service/res/rococo.json
