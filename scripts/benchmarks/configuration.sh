...
export FRAME_PALLETS=( frame_system pallet_balances pallet_bounties pallet_collective \
                        pallet_contracts pallet_democracy pallet_identity pallet_membership \
                        pallet_multisig pallet_preimage pallet_proxy pallet_scheduler \
                        pallet_timestamp pallet_treasury pallet_utility pallet_vesting \
                    ) # pallet_grandpa )
...
export FRAME_PALLETS_PARACHAIN=( 
                cumulus_pallet_xcmp_queue pallet_author_inherent pallet_author_slot_filter pallet_author_mapping pallet_parachain_staking \
)
