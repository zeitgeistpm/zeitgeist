...
export FRAME_PALLETS_PARACHAIN=( cumulus_pallet_xcmp_queue pallet_author_inherent \
                pallet_author_slot_filter pallet_author_mapping pallet_parachain_staking ) # pallet_crowdloan_rewards )
